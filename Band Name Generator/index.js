...
app.post("/submit", (req, res) => {
  ...
  let adjPick = adj[x].charAt(0).toUpperCase() + adj[x].slice(1);
  let nounPick = noun[y].charAt(0).toUpperCase() + noun[y].slice(1);
  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs", {noun: nounPick, adjective: adjPick})
